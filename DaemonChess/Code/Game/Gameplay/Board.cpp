...
void Board::Render() const
{
    ...
    if (m_resourceHandle.IsValid())
    {
        ...
        g_renderer->SetSamplerMode(eSamplerMode::POINT_CLAMP);
        g_renderer->SetDepthMode(eDepthMode::READ_WRITE_LESS_EQUAL);
        g_renderer->BindTexture(g_resourceSubsystem->CreateOrGetTextureFromFile("Data/Models/TutorialBox_Phong/Tutorial_Box_Diffuse.tga"), 0);
        g_renderer->BindTexture(g_resourceSubsystem->CreateOrGetTextureFromFile("Data/Models/TutorialBox_Phong/Tutorial_Box_Normal.tga"), 1);
        g_renderer->BindTexture(g_resourceSubsystem->CreateOrGetTextureFromFile("Data/Models/TutorialBox_Phong/Tutorial_Box_SpecGlossEmit.tga"), 2);
        g_renderer->BindShader(m_shader);
